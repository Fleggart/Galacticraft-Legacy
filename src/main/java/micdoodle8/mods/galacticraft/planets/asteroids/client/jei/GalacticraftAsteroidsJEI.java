...
public class GalacticraftAsteroidsJEI extends BlankModPlugin
{
    ...
    public void register(@Nonnull IModRegistry registry)
    {
        ...
        registry.addRecipeCatalyst(new ItemStack(GCBlocks.nasaWorkbench), RecipeCategories.ROCKET_T3_ID);
        registry.addRecipeCatalyst(new ItemStack(GCBlocks.compactNasaWorkbench), RecipeCategories.ROCKET_T3_ID);
    }
